...
macro_rules! create_quantized_spatial_index_coordinate_2d_wrapper {
    ...
    (@impl [$($visibility:tt)*] $struct_name:ident, $x_wrapper:ident, $y_wrapper:ident) => {
        $crate::__create_quantized_spatial_coordinate_2d_wrapper!(
            [$($visibility)*],
            $struct_name,
            $crate::feagi_common_spatial::index::SpatialIndexCoordinate2D<QE>,
    ...
    (@impl_concrete [$($visibility:tt)*] $struct_name:ident, $quant_element:ty, $x_wrapper:ident, $y_wrapper:ident) => {
        $crate::__create_quantized_spatial_coordinate_2d_wrapper!(
            ...
            $struct_name,
            $quant_element,
            $crate::feagi_common_spatial::index::SpatialIndexCoordinate2D<$quant_element>,
            $crate::feagi_common_quantizable::QuantizedIndexCountTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperIndexCount<$quant_element>,
            $x_wrapper,
            $y_wrapper
        );
    };
...
macro_rules! create_quantized_spatial_index_coordinate_3d_wrapper {
    ...
    (@impl [$($visibility:tt)*] $struct_name:ident, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident) => {
        $crate::__create_quantized_spatial_coordinate_3d_wrapper!(
            [$($visibility)*],
            $struct_name,
            $crate::feagi_common_spatial::index::SpatialIndexCoordinate3D<QE>,
            $crate::feagi_common_quantizable::QuantizedIndexCountTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperIndexCount<QE>,
            $x_wrapper,
            $y_wrapper,
    ...
    (@impl_concrete [$($visibility:tt)*] $struct_name:ident, $quant_element:ty, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident) => {
        $crate::__create_quantized_spatial_coordinate_3d_wrapper!(
            ...
            $struct_name,
            $quant_element,
            $crate::feagi_common_spatial::index::SpatialIndexCoordinate3D<$quant_element>,
            $crate::feagi_common_quantizable::QuantizedIndexCountTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperIndexCount<$quant_element>,
            $x_wrapper,
            $y_wrapper,
...
macro_rules! create_quantized_spatial_index_coordinate_4d_wrapper {
    ...
    (@impl [$($visibility:tt)*] $struct_name:ident, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident, $w_wrapper:ident) => {
        $crate::__create_quantized_spatial_coordinate_4d_wrapper!(
            [$($visibility)*],
            $struct_name,
            $crate::feagi_common_spatial::index::SpatialIndexCoordinate4D<QE>,
            $crate::feagi_common_quantizable::QuantizedIndexCountTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperIndexCount<QE>,
            $x_wrapper,
            $y_wrapper,
    ...
    (@impl_concrete [$($visibility:tt)*] $struct_name:ident, $quant_element:ty, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident, $w_wrapper:ident) => {
        $crate::__create_quantized_spatial_coordinate_4d_wrapper!(
            ...
            $struct_name,
            $quant_element,
            $crate::feagi_common_spatial::index::SpatialIndexCoordinate4D<$quant_element>,
            $crate::feagi_common_quantizable::QuantizedIndexCountTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperIndexCount<$quant_element>,
            $x_wrapper,
            $y_wrapper,
...
macro_rules! create_quantized_spatial_unsigned_coordinate_2d_wrapper {
    ...
    (@impl [$($visibility:tt)*] $struct_name:ident, $x_wrapper:ident, $y_wrapper:ident) => {
        $crate::__create_quantized_spatial_coordinate_2d_wrapper!(
            [$($visibility)*],
            $struct_name,
            $crate::feagi_common_spatial::unsigned_integer::SpatialUintCoordinate2D<QE>,
            $crate::feagi_common_quantizable::QuantizedUnsignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperUnsignedInteger<QE>,
            $x_wrapper,
            $y_wrapper
        );
    };
    (@impl_concrete [$($visibility:tt)*] $struct_name:ident, $quant_element:ty, $x_wrapper:ident, $y_wrapper:ident) => {
        $crate::__create_quantized_spatial_coordinate_2d_wrapper!(
            ...
            $struct_name,
            $quant_element,
            $crate::feagi_common_spatial::unsigned_integer::SpatialUintCoordinate2D<$quant_element>,
            $crate::feagi_common_quantizable::QuantizedUnsignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperUnsignedInteger<$quant_element>,
            $x_wrapper,
            $y_wrapper
        );
    };
...
macro_rules! create_quantized_spatial_unsigned_coordinate_3d_wrapper {
    ...
    (@impl [$($visibility:tt)*] $struct_name:ident, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident) => {
        $crate::__create_quantized_spatial_coordinate_3d_wrapper!(
            [$($visibility)*],
            $struct_name,
            $crate::feagi_common_spatial::unsigned_integer::SpatialUintCoordinate3D<QE>,
            $crate::feagi_common_quantizable::QuantizedUnsignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperUnsignedInteger<QE>,
            $x_wrapper,
            $y_wrapper,
    ...
    (@impl_concrete [$($visibility:tt)*] $struct_name:ident, $quant_element:ty, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident) => {
        $crate::__create_quantized_spatial_coordinate_3d_wrapper!(
            ...
            $struct_name,
            $quant_element,
            $crate::feagi_common_spatial::unsigned_integer::SpatialUintCoordinate3D<$quant_element>,
            $crate::feagi_common_quantizable::QuantizedUnsignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperUnsignedInteger<$quant_element>,
            $x_wrapper,
            $y_wrapper,
...
macro_rules! create_quantized_spatial_unsigned_coordinate_4d_wrapper {
    ...
    (@impl [$($visibility:tt)*] $struct_name:ident, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident, $w_wrapper:ident) => {
        $crate::__create_quantized_spatial_coordinate_4d_wrapper!(
            [$($visibility)*],
            $struct_name,
            $crate::feagi_common_spatial::unsigned_integer::SpatialUintCoordinate4D<QE>,
            $crate::feagi_common_quantizable::QuantizedUnsignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperUnsignedInteger<QE>,
            $x_wrapper,
            $y_wrapper,
    ...
    (@impl_concrete [$($visibility:tt)*] $struct_name:ident, $quant_element:ty, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident, $w_wrapper:ident) => {
        $crate::__create_quantized_spatial_coordinate_4d_wrapper!(
            ...
            $struct_name,
            $quant_element,
            $crate::feagi_common_spatial::unsigned_integer::SpatialUintCoordinate4D<$quant_element>,
            $crate::feagi_common_quantizable::QuantizedUnsignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperUnsignedInteger<$quant_element>,
            $x_wrapper,
            $y_wrapper,
...
macro_rules! create_quantized_spatial_signed_coordinate_2d_wrapper {
    ...
    (@impl [$($visibility:tt)*] $struct_name:ident, $x_wrapper:ident, $y_wrapper:ident) => {
        $crate::__create_quantized_spatial_coordinate_2d_wrapper!(
            [$($visibility)*],
            $struct_name,
            $crate::feagi_common_spatial::signed_integer::SpatialSintCoordinate2D<QE>,
            $crate::feagi_common_quantizable::QuantizedSignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperSignedInteger<QE>,
            $x_wrapper,
            $y_wrapper
        );
    };
    (@impl_concrete [$($visibility:tt)*] $struct_name:ident, $quant_element:ty, $x_wrapper:ident, $y_wrapper:ident) => {
        $crate::__create_quantized_spatial_coordinate_2d_wrapper!(
            ...
            $struct_name,
            $quant_element,
            $crate::feagi_common_spatial::signed_integer::SpatialSintCoordinate2D<$quant_element>,
            $crate::feagi_common_quantizable::QuantizedSignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperSignedInteger<$quant_element>,
            $x_wrapper,
            $y_wrapper
        );
    };
...
macro_rules! create_quantized_spatial_signed_coordinate_3d_wrapper {
    ...
    (@impl [$($visibility:tt)*] $struct_name:ident, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident) => {
        $crate::__create_quantized_spatial_coordinate_3d_wrapper!(
            [$($visibility)*],
            $struct_name,
            $crate::feagi_common_spatial::signed_integer::SpatialSintCoordinate3D<QE>,
            $crate::feagi_common_quantizable::QuantizedSignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperSignedInteger<QE>,
            $x_wrapper,
            $y_wrapper,
    ...
    (@impl_concrete [$($visibility:tt)*] $struct_name:ident, $quant_element:ty, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident) => {
        $crate::__create_quantized_spatial_coordinate_3d_wrapper!(
            ...
            $struct_name,
            $quant_element,
            $crate::feagi_common_spatial::signed_integer::SpatialSintCoordinate3D<$quant_element>,
            $crate::feagi_common_quantizable::QuantizedSignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperSignedInteger<$quant_element>,
            $x_wrapper,
            $y_wrapper,
...
macro_rules! create_quantized_spatial_signed_coordinate_4d_wrapper {
    ...
    (@impl [$($visibility:tt)*] $struct_name:ident, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident, $w_wrapper:ident) => {
        $crate::__create_quantized_spatial_coordinate_4d_wrapper!(
            [$($visibility)*],
            $struct_name,
            $crate::feagi_common_spatial::signed_integer::SpatialSintCoordinate4D<QE>,
            $crate::feagi_common_quantizable::QuantizedSignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperSignedInteger<QE>,
            $x_wrapper,
            $y_wrapper,
    ...
    (@impl_concrete [$($visibility:tt)*] $struct_name:ident, $quant_element:ty, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident, $w_wrapper:ident) => {
        $crate::__create_quantized_spatial_coordinate_4d_wrapper!(
            ...
            $struct_name,
            $quant_element,
            $crate::feagi_common_spatial::signed_integer::SpatialSintCoordinate4D<$quant_element>,
            $crate::feagi_common_quantizable::QuantizedSignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperSignedInteger<$quant_element>,
            $x_wrapper,
            $y_wrapper,
...
macro_rules! create_quantized_spatial_index_dimensions_2d_wrapper {
    ...
    (@impl [$($visibility:tt)*] $struct_name:ident, $coordinate_wrapper:ident, $linear_wrapper:ident, $x_wrapper:ident, $y_wrapper:ident) => {
        $crate::__create_quantized_spatial_dimensions_2d_wrapper!(
            [$($visibility)*],
            $struct_name,
            $crate::feagi_common_spatial::index::SpatialIndexDimensions2D<QE>,
            $crate::feagi_common_spatial::index::SpatialIndexCoordinate2D<QE>,
            $crate::feagi_common_quantizable::QuantizedIndexCountTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperIndexCount<QE>,
            $coordinate_wrapper,
    ...
    (@impl_concrete [$($visibility:tt)*] $struct_name:ident, $quant_element:ty, $coordinate_wrapper:ident, $linear_wrapper:ident, $x_wrapper:ident, $y_wrapper:ident) => {
        $crate::__create_quantized_spatial_dimensions_2d_wrapper!(
            ...
            $struct_name,
            $quant_element,
            $crate::feagi_common_spatial::index::SpatialIndexDimensions2D<$quant_element>,
            $crate::feagi_common_spatial::index::SpatialIndexCoordinate2D<$quant_element>,
            $crate::feagi_common_quantizable::QuantizedIndexCountTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperIndexCount<$quant_element>,
            $coordinate_wrapper,
...
macro_rules! create_quantized_spatial_index_dimensions_3d_wrapper {
    ...
    (@impl [$($visibility:tt)*] $struct_name:ident, $coordinate_wrapper:ident, $linear_wrapper:ident, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident) => {
        $crate::__create_quantized_spatial_dimensions_3d_wrapper!(
            [$($visibility)*],
            $struct_name,
            $crate::feagi_common_spatial::index::SpatialIndexDimensions3D<QE>,
            $crate::feagi_common_spatial::index::SpatialIndexCoordinate3D<QE>,
            $crate::feagi_common_quantizable::QuantizedIndexCountTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperIndexCount<QE>,
            $coordinate_wrapper,
    ...
    (@impl_concrete [$($visibility:tt)*] $struct_name:ident, $quant_element:ty, $coordinate_wrapper:ident, $linear_wrapper:ident, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident) => {
        $crate::__create_quantized_spatial_dimensions_3d_wrapper!(
            ...
            $struct_name,
            $quant_element,
            $crate::feagi_common_spatial::index::SpatialIndexDimensions3D<$quant_element>,
            $crate::feagi_common_spatial::index::SpatialIndexCoordinate3D<$quant_element>,
            $crate::feagi_common_quantizable::QuantizedIndexCountTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperIndexCount<$quant_element>,
            $coordinate_wrapper,
...
macro_rules! create_quantized_spatial_index_dimensions_4d_wrapper {
    ...
    (@impl [$($visibility:tt)*] $struct_name:ident, $coordinate_wrapper:ident, $linear_wrapper:ident, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident, $w_wrapper:ident) => {
        $crate::__create_quantized_spatial_dimensions_4d_wrapper!(
            [$($visibility)*],
            $struct_name,
            $crate::feagi_common_spatial::index::SpatialIndexDimensions4D<QE>,
            $crate::feagi_common_spatial::index::SpatialIndexCoordinate4D<QE>,
            $crate::feagi_common_quantizable::QuantizedIndexCountTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperIndexCount<QE>,
            $coordinate_wrapper,
    ...
    (@impl_concrete [$($visibility:tt)*] $struct_name:ident, $quant_element:ty, $coordinate_wrapper:ident, $linear_wrapper:ident, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident, $w_wrapper:ident) => {
        $crate::__create_quantized_spatial_dimensions_4d_wrapper!(
            ...
            $struct_name,
            $quant_element,
            $crate::feagi_common_spatial::index::SpatialIndexDimensions4D<$quant_element>,
            $crate::feagi_common_spatial::index::SpatialIndexCoordinate4D<$quant_element>,
            $crate::feagi_common_quantizable::QuantizedIndexCountTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperIndexCount<$quant_element>,
            $coordinate_wrapper,
...
macro_rules! create_quantized_spatial_unsigned_dimensions_2d_wrapper {
    ...
    (@impl [$($visibility:tt)*] $struct_name:ident, $coordinate_wrapper:ident, $x_wrapper:ident, $y_wrapper:ident) => {
        $crate::__create_quantized_spatial_dimensions_2d_wrapper!(
            [$($visibility)*],
            $struct_name,
            $crate::feagi_common_spatial::unsigned_integer::SpatialUintDimensions2D<QE>,
            $crate::feagi_common_spatial::unsigned_integer::SpatialUintCoordinate2D<QE>,
            $crate::feagi_common_quantizable::QuantizedUnsignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperUnsignedInteger<QE>,
            $coordinate_wrapper,
    ...
    (@impl_concrete [$($visibility:tt)*] $struct_name:ident, $quant_element:ty, $coordinate_wrapper:ident, $x_wrapper:ident, $y_wrapper:ident) => {
        $crate::__create_quantized_spatial_dimensions_2d_wrapper!(
            ...
            $struct_name,
            $quant_element,
            $crate::feagi_common_spatial::unsigned_integer::SpatialUintDimensions2D<$quant_element>,
            $crate::feagi_common_spatial::unsigned_integer::SpatialUintCoordinate2D<$quant_element>,
            $crate::feagi_common_quantizable::QuantizedUnsignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperUnsignedInteger<$quant_element>,
            $coordinate_wrapper,
...
macro_rules! create_quantized_spatial_unsigned_dimensions_3d_wrapper {
    ...
    (@impl [$($visibility:tt)*] $struct_name:ident, $coordinate_wrapper:ident, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident) => {
        $crate::__create_quantized_spatial_dimensions_3d_wrapper!(
            [$($visibility)*],
            $struct_name,
            $crate::feagi_common_spatial::unsigned_integer::SpatialUintDimensions3D<QE>,
            $crate::feagi_common_spatial::unsigned_integer::SpatialUintCoordinate3D<QE>,
            $crate::feagi_common_quantizable::QuantizedUnsignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperUnsignedInteger<QE>,
            $coordinate_wrapper,
    ...
    (@impl_concrete [$($visibility:tt)*] $struct_name:ident, $quant_element:ty, $coordinate_wrapper:ident, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident) => {
        $crate::__create_quantized_spatial_dimensions_3d_wrapper!(
            ...
            $struct_name,
            $quant_element,
            $crate::feagi_common_spatial::unsigned_integer::SpatialUintDimensions3D<$quant_element>,
            $crate::feagi_common_spatial::unsigned_integer::SpatialUintCoordinate3D<$quant_element>,
            $crate::feagi_common_quantizable::QuantizedUnsignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperUnsignedInteger<$quant_element>,
            $coordinate_wrapper,
...
macro_rules! create_quantized_spatial_unsigned_dimensions_4d_wrapper {
    ...
    (@impl [$($visibility:tt)*] $struct_name:ident, $coordinate_wrapper:ident, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident, $w_wrapper:ident) => {
        $crate::__create_quantized_spatial_dimensions_4d_wrapper!(
            [$($visibility)*],
            $struct_name,
            $crate::feagi_common_spatial::unsigned_integer::SpatialDimensions4D<QE>,
            $crate::feagi_common_spatial::unsigned_integer::SpatialUintCoordinate4D<QE>,
            $crate::feagi_common_quantizable::QuantizedUnsignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperUnsignedInteger<QE>,
            $coordinate_wrapper,
    ...
    (@impl_concrete [$($visibility:tt)*] $struct_name:ident, $quant_element:ty, $coordinate_wrapper:ident, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident, $w_wrapper:ident) => {
        $crate::__create_quantized_spatial_dimensions_4d_wrapper!(
            ...
            $struct_name,
            $quant_element,
            $crate::feagi_common_spatial::unsigned_integer::SpatialDimensions4D<$quant_element>,
            $crate::feagi_common_spatial::unsigned_integer::SpatialUintCoordinate4D<$quant_element>,
            $crate::feagi_common_quantizable::QuantizedUnsignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperUnsignedInteger<$quant_element>,
            $coordinate_wrapper,
...
macro_rules! create_quantized_spatial_signed_dimensions_2d_wrapper {
    ...
    (@impl [$($visibility:tt)*] $struct_name:ident, $coordinate_wrapper:ident, $x_wrapper:ident, $y_wrapper:ident) => {
        $crate::__create_quantized_spatial_dimensions_2d_wrapper!(
            [$($visibility)*],
            $struct_name,
            $crate::feagi_common_spatial::signed_integer::SpatialSintDimensions2D<QE>,
            $crate::feagi_common_spatial::signed_integer::SpatialSintCoordinate2D<QE>,
            $crate::feagi_common_quantizable::QuantizedSignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperSignedInteger<QE>,
            $coordinate_wrapper,
    ...
    (@impl_concrete [$($visibility:tt)*] $struct_name:ident, $quant_element:ty, $coordinate_wrapper:ident, $x_wrapper:ident, $y_wrapper:ident) => {
        $crate::__create_quantized_spatial_dimensions_2d_wrapper!(
            ...
            $struct_name,
            $quant_element,
            $crate::feagi_common_spatial::signed_integer::SpatialSintDimensions2D<$quant_element>,
            $crate::feagi_common_spatial::signed_integer::SpatialSintCoordinate2D<$quant_element>,
            $crate::feagi_common_quantizable::QuantizedSignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperSignedInteger<$quant_element>,
            $coordinate_wrapper,
...
macro_rules! create_quantized_spatial_signed_dimensions_3d_wrapper {
    ...
    (@impl [$($visibility:tt)*] $struct_name:ident, $coordinate_wrapper:ident, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident) => {
        $crate::__create_quantized_spatial_dimensions_3d_wrapper!(
            [$($visibility)*],
            $struct_name,
            $crate::feagi_common_spatial::signed_integer::SpatialSintDimensions3D<QE>,
            $crate::feagi_common_spatial::signed_integer::SpatialSintCoordinate3D<QE>,
            $crate::feagi_common_quantizable::QuantizedSignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperSignedInteger<QE>,
            $coordinate_wrapper,
    ...
    (@impl_concrete [$($visibility:tt)*] $struct_name:ident, $quant_element:ty, $coordinate_wrapper:ident, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident) => {
        $crate::__create_quantized_spatial_dimensions_3d_wrapper!(
            ...
            $struct_name,
            $quant_element,
            $crate::feagi_common_spatial::signed_integer::SpatialSintDimensions3D<$quant_element>,
            $crate::feagi_common_spatial::signed_integer::SpatialSintCoordinate3D<$quant_element>,
            $crate::feagi_common_quantizable::QuantizedSignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperSignedInteger<$quant_element>,
            $coordinate_wrapper,
...
macro_rules! create_quantized_spatial_signed_dimensions_4d_wrapper {
    ...
    (@impl [$($visibility:tt)*] $struct_name:ident, $coordinate_wrapper:ident, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident, $w_wrapper:ident) => {
        $crate::__create_quantized_spatial_dimensions_4d_wrapper!(
            [$($visibility)*],
            $struct_name,
            $crate::feagi_common_spatial::signed_integer::SpatialDimensions4D<QE>,
            $crate::feagi_common_spatial::signed_integer::SpatialSintCoordinate4D<QE>,
            $crate::feagi_common_quantizable::QuantizedSignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperSignedInteger<QE>,
            $coordinate_wrapper,
    ...
    (@impl_concrete [$($visibility:tt)*] $struct_name:ident, $quant_element:ty, $coordinate_wrapper:ident, $x_wrapper:ident, $y_wrapper:ident, $z_wrapper:ident, $w_wrapper:ident) => {
        $crate::__create_quantized_spatial_dimensions_4d_wrapper!(
            ...
            $struct_name,
            $quant_element,
            $crate::feagi_common_spatial::signed_integer::SpatialDimensions4D<$quant_element>,
            $crate::feagi_common_spatial::signed_integer::SpatialSintCoordinate4D<$quant_element>,
            $crate::feagi_common_quantizable::QuantizedSignedIntegerTrait,
            $crate::data_wrappers::quantizable::wrapper_traits::QuantizedElementWrapperSignedInteger<$quant_element>,
            $coordinate_wrapper,
