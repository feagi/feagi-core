...
/// tertiary cortical_area area information
    ...
    FGIQ: FeagiGlobalQuantization,
{
    ...
    // cortical_area indexes, but rather only properties that the user can somehow set through bv
}
    ...
    AxonHeaderData: AxonBundleHeaderDataCommon<FGIQ>
{
    ...
    // cortical_area indexes and FCL read/write offsets
