use crate::{define_xy_coordinates, define_xyz_coordinates, define_index};

define_xy_coordinates!(GenomeCoordinate2D, i32, "GenomeCoordinate2D",
...
define_xyz_coordinates!(GenomeCoordinate3D, i32, "GenomeCoordinate3D",
