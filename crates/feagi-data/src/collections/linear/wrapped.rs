...
//! the raw [`QuantizedUnsignedIntegerTrait`](crate::values::quantizable::QuantizedUnsignedIntegerTrait)
...
macro_rules! create_wrapped_contiguous_slice {
    (
        ...
        $(#[$meta])*
        #[repr(transparent)]
        $vis struct $struct_name<'a, Q: $crate::values::quantizable::QuantizedUnsignedIntegerTrait, V: Clone >(
            $crate::collections::linear::contiguous_data::QuantizedContiguousSlice<'a, Q, V>
        );

        impl<'a, Q: $crate::values::quantizable::QuantizedUnsignedIntegerTrait, V: Clone > Clone
        ...
        impl<'a, Q: $crate::values::quantizable::QuantizedUnsignedIntegerTrait, V: Clone >
            $struct_name<'a, Q, V>
        {
...
macro_rules! create_wrapped_contiguous_vector {
    (
        ...
        $(#[$meta])*
        #[repr(transparent)]
        $vis struct $struct_name<Q: $crate::values::quantizable::QuantizedUnsignedIntegerTrait, V: Clone >(
            $crate::collections::linear::contiguous_data::QuantizedContiguousVector<Q, V>
        );

        impl<Q: $crate::values::quantizable::QuantizedUnsignedIntegerTrait, V: Clone > Clone
            for $struct_name<Q, V>
        {
            fn clone(&self) -> Self {
                Self(self.0.clone())
        ...
        impl<Q: $crate::values::quantizable::QuantizedUnsignedIntegerTrait, V: Clone > Default
            for $struct_name<Q, V>
        {
            fn default() -> Self {
                Self::new_empty()
        ...
        impl<Q: $crate::values::quantizable::QuantizedUnsignedIntegerTrait, V: Clone >
            $struct_name<Q, V>
        {
...
macro_rules! create_wrapped_contiguous_array {
    (
        ...
        $(#[$meta])*
        #[repr(transparent)]
        $vis struct $struct_name<Q: $crate::values::quantizable::QuantizedUnsignedIntegerTrait, V: Clone , const N: usize>(
            $crate::collections::linear::contiguous_data::QuantizedContiguousArray<Q, V, N>
        );

        impl<Q: $crate::values::quantizable::QuantizedUnsignedIntegerTrait, V: Clone , const N: usize> Clone
        ...
        impl<Q: $crate::values::quantizable::QuantizedUnsignedIntegerTrait, V: Clone , const N: usize>
            $struct_name<Q, V, N>
        {
