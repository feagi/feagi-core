...
/// Defines the quantization used in a cortical_area area for the calculation of neuron dynamics.
/// All are required to support neuron potentials, hence this is the shared base of each model's
/// implementation. Each cortical_area area within an NPU may have different quantization levels.
...
pub trait NeuronModelQuantization
{
    ...
    /// include. This may vary between cortical_area areas, even of the same model
