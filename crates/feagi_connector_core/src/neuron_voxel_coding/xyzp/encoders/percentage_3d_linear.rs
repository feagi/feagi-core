    ...
    fn write_neuron_data_multi_channel_from_processed_cache(&mut self, pipelines: &Vec<PipelineStageRunner>, time_of_previous_burst: Instant, write_target: &mut CorticalMappedXYZPNeuronVoxels) -> Result<(), FeagiDataError> {
        ...
        pipelines.par_iter()
            ...
            .try_for_each(|(channel_index, (pipeline, scratch))| -> Result<(), FeagiDataError> {
                ...
                encode_unsigned_percentage_to_linear_neuron_z_index(&updated_percentage_3d.a, z_length_as_float, &mut scratch.0);
                encode_unsigned_percentage_to_linear_neuron_z_index(&updated_percentage_3d.b, z_length_as_float, &mut scratch.1);
                encode_unsigned_percentage_to_linear_neuron_z_index(&updated_percentage_3d.c, z_length_as_float, &mut scratch.2);
