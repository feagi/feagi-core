...
use feagi_sensorimotor::data_types::descriptors::{ColorChannelLayout, ColorSpace, ImageFrameProperties, ImageXYResolution};
...
fn main() {
    ...
    blocking_agent.get_embodiment_mut().get_motor_cache()
        .gaze_register(
            0.into(),
            1.into(),
            Default::default(),
    ...
    blocking_agent.get_embodiment_mut().get_sensor_cache()
        .vision_register(
            0.into(),
            1.into(),
            Default::default(),
