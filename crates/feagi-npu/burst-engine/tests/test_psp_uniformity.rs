...
fn test_psp_uniformity_false_divides_psp() {
    ...
    println!("✓ PSP uniformity = false test: {} synapses created", npu.get_synapse_count());
...
fn test_psp_uniformity_true_applies_full_psp() {
    ...
    println!("✓ PSP uniformity = true test: {} synapses created", npu.get_synapse_count());
...
fn test_psp_uniformity_default_is_false() {
    ...
    println!("✓ Default behavior test: {} synapses created", npu.get_synapse_count());
