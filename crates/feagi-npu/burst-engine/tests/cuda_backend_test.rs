...
mod cuda_tests {
    ...
    fn test_cuda_backend_initialization() {
        ...
        let mut backend = CUDABackend::new(1_000, 10_000).expect("Failed to create CUDA backend");
...
fn test_cuda_compile_time_validation() {
    ...
    #[cfg(feature = "cuda")]
    {
        ...
        let _: fn() -> Vec<(usize, String, u64)> =
            feagi_npu_burst_engine::backend::enumerate_cuda_devices;
