...
fn test_backend_trait_object_safety() {
    ...
    use feagi_npu_runtime_std::{NeuronArray, SynapseArray};
    fn _uses_trait_object(_backend: &dyn feagi_npu_burst_engine::backend::ComputeBackend<f32, NeuronArray<f32>, SynapseArray>) {
...
fn test_cuda_compile_time_validation() {
    ...
    #[cfg(feature = "cuda")]
    {
        ...
        let _: fn() -> bool = feagi_npu_burst_engine::backend::is_cuda_available;
        let _: fn() -> Vec<(usize, String, u64)> = feagi_npu_burst_engine::backend::enumerate_cuda_devices;
