        ...
        + ComputeBackend<INT8Value, R::NeuronStorage<INT8Value>, R::SynapseStorage>,
{
        ...
        match self {
            ...
            DynamicNPUGeneric::INT8(npu) => {
                ...
                npu.add_neurons_batch(
                    thresholds_int8, leak_coefficients, resting_int8,
                    neuron_types, refractory_periods, excitabilities,
                    consecutive_fire_limits, snooze_periods, mp_charge_accumulations,
                    cortical_areas, x_coords, y_coords, z_coords
                )
    ...
    pub fn add_synapse(
        ...
        dispatch_mut!(self, add_synapse(source, target, weight, conductance, synapse_type))
    }
    ...
    pub fn update_cortical_area_excitability(&mut self, cortical_area: u32, excitability: f32) -> usize {
        dispatch_mut!(self, update_cortical_area_excitability(cortical_area, excitability))
    }
    ...
    pub fn update_cortical_area_threshold(&mut self, cortical_area: u32, threshold: f32) -> usize {
        dispatch_mut!(self, update_cortical_area_threshold(cortical_area, threshold))
    }
    
    pub fn update_cortical_area_refractory_period(&mut self, cortical_area: u32, period: u16) -> usize {
        dispatch_mut!(self, update_cortical_area_refractory_period(cortical_area, period))
    }
    
    pub fn update_cortical_area_snooze_period(&mut self, cortical_area: u32, period: u16) -> usize {
        dispatch_mut!(self, update_cortical_area_snooze_period(cortical_area, period))
    }
    
    pub fn update_cortical_area_consecutive_fire_limit(&mut self, cortical_area: u32, limit: u16) -> usize {
        dispatch_mut!(self, update_cortical_area_consecutive_fire_limit(cortical_area, limit))
    }
    
    pub fn update_cortical_area_mp_charge_accumulation(&mut self, cortical_area: u32, accumulation: bool) -> usize {
        dispatch_mut!(self, update_cortical_area_mp_charge_accumulation(cortical_area, accumulation))
    }
    ...
    pub fn inject_sensory_with_potentials(&mut self, neurons: &[(feagi_npu_neural::types::NeuronId, f32)]) {
        match self {
    ...
    pub fn batch_get_neuron_ids_from_coordinates(&self, area_id: u32, coords: &[(u32, u32, u32)]) -> Vec<feagi_npu_neural::types::NeuronId> {
