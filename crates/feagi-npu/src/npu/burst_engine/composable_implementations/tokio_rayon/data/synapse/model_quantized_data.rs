...
mod uniform_model {
    ...
    pub struct QuantizationStandard<FIQ: FeagiIndexQuantization> {
        pub mapping_entry_data: MappingEntryModelIndexedVector<
            FIQ::CorticalMappingEntryIndexCountQuant,
            UniformSynapseModelCorticalMappingEntryData<UniformSynapseModelStandardQuant>,
        >,
    }
