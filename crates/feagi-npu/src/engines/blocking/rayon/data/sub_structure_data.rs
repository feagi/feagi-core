...
use feagi_npu_common::wrapped_indexes::{BurstIndex, CorticalLayoutIndex, CorticalModelIndex, NeuronEngineIndex, NeuronHistoryIndex};
...
/// 
pub struct CorticalContextIndexes<FIQ: FeagiIndexQuantization>
{
