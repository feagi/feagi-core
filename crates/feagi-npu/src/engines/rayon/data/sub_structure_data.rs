...
use feagi_models::wrapped_index_collections::{CorticalLayoutIndex, CorticalModelIndex, NeuronEngineByteIndex, NeuronEngineIndex, NeuronHistoryIndex, NeuronMPIndex, NeuronModelIndex};
...
impl<FIQ: FeagiIndexQuantization> NeuronIndexLookupTable<FIQ> {
    ...
    pub fn get_neuron_engine_index_range_for_group(&self, group_index: &NeuronEngineByteIndex<FIQ::NeuronIndexCountQuant>, cortical_number_of_neurons: FIQ::NeuronIndexCountQuant) -> Range<usize> {
    ...
    pub fn get_neuron_model_index(&self, from_engine_index: &NeuronEngineIndex<FIQ::NeuronIndexCountQuant>) -> NeuronModelIndex<FIQ::NeuronIndexCountQuant>{
