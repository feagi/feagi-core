...
impl<FGQ, SMQ, CPQIn, CPQOut>
    SynapseModelProcessorBase<FGQ, SMQ, BasicSynapseModelAxonBundleData<SMQ>, CPQIn, CPQOut>
    for BasicSynapseModelProcessor<FGQ, SMQ, CPQIn, CPQOut>
where
    FGQ: FeagiGlobalQuantization,
    SMQ: BasicSynapseModelQuantization,
    CPQIn: CorticalPotentialQuantization,
