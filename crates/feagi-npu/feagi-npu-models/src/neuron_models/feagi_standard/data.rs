...
where
    NMQ: FeagiStandardModelQuantization,
{
    pub neuron_fire_threshold: NeuronMembranePotential<
    ...
    pub neuron_consecutive_fire_countdown:
        ConsecutiveFireCountdown<NMQ::NeuronConsecutiveFireCountdownQuant>,
    _p: PhantomData<NMQ>,
}

impl<NMQ> NeuronModelNeuronData<NMQ> for FeagiStandardModelNeuronData<NMQ> where
    NMQ: FeagiStandardModelQuantization
{
}
...
{
    pub fn new(
        neuron_fire_threshold: NeuronMembranePotential<
            <NMQ::CorticalPotentialQuant as CorticalPotentialQuantization>::NeuronPotentialQuant,
        >,
        ...
        neuron_consecutive_fire_countdown: ConsecutiveFireCountdown<
            NMQ::NeuronConsecutiveFireCountdownQuant,
        >,
    ) -> Self {
        Self {
