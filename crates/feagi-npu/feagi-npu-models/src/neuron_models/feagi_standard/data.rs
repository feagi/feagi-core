...
use crate::neuron_models::neuron_model_traits::neuron_model_cortical_data::{NeuronModelCorticalData, NeuronModelCorticalDataCPU};
use crate::neuron_models::neuron_model_traits::neuron_model_neuron_data::{NeuronModelNeuronData, NeuronModelNeuronDataCPU};
    ...
    NMQ: FeagiStandardModelQuantization,
{
    ...
    pub fire_threshold_limit: NMQ::CorticalFireThreshold,

    pub consecutive_fire_limit: NMQ::CorticalConsecutiveFireLimit,

    pub snooze_period: NMQ::CorticalSnoozePeriod,

    pub degeneracy_constant: NMQ::CorticalDegeneracyConstant,
    ...
    NMQ: FeagiStandardModelQuantization,
{
    pub fn new(
        ...
        fire_threshold_limit: NMQ::CorticalFireThreshold,
        consecutive_fire_limit: NMQ::CorticalConsecutiveFireLimit,
        snooze_period: NMQ::CorticalSnoozePeriod,
        degeneracy_constant: NMQ::CorticalDegeneracyConstant,
    ) -> Self {
        Self {
            excitability,
