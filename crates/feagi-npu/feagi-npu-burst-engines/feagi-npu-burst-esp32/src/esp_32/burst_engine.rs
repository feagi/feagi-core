...
use feagi_npu_burst_core::npu_sealed::non_composable::{
    NonComposableBurstEngine, NonComposableBurstEngineSpawnerNPU, NonComposableBurstPhaseOutput, NonComposablePhaseNotification,
};
use feagi_npu_burst_core::npu_sealed::wrapped_values::EngineCorticalIndex;
use feagi_npu_burst_core::NonComposableBurstEngineSpawner;
...
impl<FIQ: FeagiIndexQuantization> NonComposableBurstEngine<FIQ> for ESP32BoardESP32BurstEngine<FIQ> {
    fn execute_phase(
        ...
        temp.add_notification(NonComposablePhaseNotification::BrainDeathTriggered {
