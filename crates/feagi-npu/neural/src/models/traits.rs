...
// Note: Will use feagi-neural::types after Phase 2c merge
// For now, these types are still in feagi-types (to be moved)
...
/// Synapse type (re-exported from synapse module for convenience)
///
/// Note: After Phase 2c merge, this will come from feagi-neural::types
