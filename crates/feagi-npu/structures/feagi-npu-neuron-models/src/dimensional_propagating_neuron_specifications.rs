...
use crate::neuron_old::model_specifications::base_propagating_neuron_specifications::base_propagating_neuron_specifications::BasePropagatingNeuronsCollectionSharedTrait;
use crate::neuron_old::model_specifications::base_propagating_neuron_specifications::HasNeuronFired;
use crate::neuron_old::model_specifications::base_specifications::{LinearNeuronIndexCount, NeuronMembranePotential};
