...
pub struct InterNeuronAllocRAMStorage<Q: NPUQuantization>
{
    ...
    neuron_cortical_area_index: Vec<CorticalAreaIndex<Q::CorticalIndexQuant>>, // faster than potentially reverse looking up a large hashmap // TODO lookup table?
    ...
    cortical_datas: IndexedDataTracker<DimensionalNeuronCorticalData<Q>, CorticalAreaIndex<Q::CorticalIndexQuant>>,
