...
for MotorNeuronAllocRAMStorage<Q>
{
    ...
    fn create_cortical_area_with_uniform_neurons(&mut self,
        ...
        let (output_cortical_index,  output_neuron_region, _) = default_create_cortical_area_with_uniform_neurons::<Q, MotorNeuronsDefaults<Q>>(
    ...
    fn default_create_cortical_area_with_individualized_neurons(&mut self,
                                                                ...
                                                                -> Result<(CorticalAreaIndex<Q::CorticalIndex>, Range<NPUNeuronIndex<Q::NeuronIndex>>), FeagiNPUNeuronError> {
        let (output_cortical_index,  output_neuron_region, _) = create_cortical_area_with_individualized_neurons::<Q, MotorNeuronsDefaults<Q>>(
            cortical_area_dimensions,
            neurons_per_voxel,
            neuron_data,
            &mut self.neuron_cortical_area_index,
