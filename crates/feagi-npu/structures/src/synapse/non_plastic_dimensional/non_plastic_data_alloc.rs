...
pub struct NonplasticDimensionalSynapseAllocRAMStorage<Q: NPUQuantization>
{
    ...
    source_to_synapse: AHashMap<NPUNeuronIndex<Q::NeuronIndex>, Vec<NPUSynapseIndex<Q::SynapseIndex>>>,
    destination_to_synapse: AHashMap<NPUNeuronIndex<Q::NeuronIndex>, Vec<NPUSynapseIndex<Q::SynapseIndex>>>,

    // Cached Data
    cache_total_synapse_count: SynapseCount<Q::SynapseIndex>,
    ...
    cache_valid_synapse_blocks: AHashMap<
        ...
        InvalidatableVector<core::ops::Range<NPUSynapseIndex<Q::SynapseIndex>>>
    >,
    /// Includes ranges of entire invalid synapse blocks. Does NOT include singular dead synapses
    cache_invalid_synapse_blocks: Vec<core::ops::Range<NPUSynapseIndex<Q::SynapseIndex>>>,
...
NonplasticDimensionalSynapseAllocRAMStorage<Q>
{
    ...
    fn get_synapse_data_at_synapse_index(&self, synapse_index: NPUSynapseIndex<Q::SynapseIndex>) -> Result<&NonPlasticSynapseFull<Q::NeuronIndex, Q::BurstDelta, Q::Value>, FeagiNPUSynapseError>
    {
    ...
    fn get_valid_synapse_data_at_synapse_index(&self, synapse_index: NPUSynapseIndex<Q::SynapseIndex>) -> Result<&NonPlasticSynapseFull<Q::NeuronIndex, Q::BurstDelta, Q::Value>, FeagiNPUSynapseError>
    {
    ...
    /// Tries to get synapse at given index. Errors if index is invalid. DOES NOT CHECK IF SYNAPSE IS VALID
    fn get_synapse_data_at_synapse_index_mut(&mut self, synapse_index: NPUSynapseIndex<Q::SynapseIndex>) -> Result<&mut NonPlasticSynapseFull<Q::NeuronIndex, Q::BurstDelta, Q::Value>, FeagiNPUSynapseError>
    {
        let index_synapse: usize = synapse_index.to_usize();
    ...
    /// Tries to get a valid synapse at given index. Checks if index and synapse valid
    fn get_valid_synapse_data_at_synapse_index_mut(&mut self, synapse_index: NPUSynapseIndex<Q::SynapseIndex>) -> Result<&mut NonPlasticSynapseFull<Q::NeuronIndex, Q::BurstDelta, Q::Value>, FeagiNPUSynapseError>
    {
    ...
    fn get_synapse_indexes_from_source_neuron_index(&self, source_neuron_index: &NPUNeuronIndex<Q::NeuronIndex>) -> &[NPUSynapseIndex<Q::SynapseIndex>] {
    ...
    /// Gets all synapse indexes that have the following source_neuron_index. Returns empty if nothing found
    fn get_synapse_indexes_from_destination_neuron_index(&self, destination_neuron_index: &NPUNeuronIndex<Q::NeuronIndex>) ->  &[NPUSynapseIndex<Q::SynapseIndex>] {
    ...
    fn get_synapse_data_from_source_neuron_index(&self, source_neuron_index: &NPUNeuronIndex<Q::NeuronIndex>) -> Result<(impl Iterator<Item=&NonPlasticSynapseFull<Q::NeuronIndex, Q::BurstDelta, Q::Value>>, NeuronCount<Q::NeuronIndex>), FeagiNPUSynapseError> {
    ...
    fn get_synapse_data_from_destination_neuron_index(&self, destination_neuron_index: &NPUNeuronIndex<Q::NeuronIndex>) -> Result<(impl Iterator<Item=&NonPlasticSynapseFull<Q::NeuronIndex, Q::BurstDelta, Q::Value>>, NeuronCount<Q::NeuronIndex>), FeagiNPUSynapseError> {
    ...
    fn get_synapse_data_from_source_neuron_index_mut(&mut self, source_neuron_index: &NPUNeuronIndex<Q::NeuronIndex>) -> Result<(impl Iterator<Item=&mut NonPlasticSynapseFull<Q::NeuronIndex, Q::BurstDelta, Q::Value>>, NeuronCount<Q::NeuronIndex>), FeagiNPUSynapseError> {
    ...
    fn get_synapse_data_from_destination_neuron_index_mut(&mut self, destination_neuron_index: &NPUNeuronIndex<Q::NeuronIndex>) -> Result<(impl Iterator<Item=&mut NonPlasticSynapseFull<Q::NeuronIndex, Q::BurstDelta, Q::Value>>, NeuronCount<Q::NeuronIndex>), FeagiNPUSynapseError> {
...
NonplasticDimensionalSynapseAllocRAMStorage<Q>
{
    ...
    fn get_nonplastic_synapse_data_from_source_neuron_index(&self, source_neuron_index: NPUNeuronIndex<Q::NeuronIndex>) -> Result<(impl Iterator<Item=&NonPlasticSynapseFull<Q::NeuronIndex, Q::BurstDelta, Q::Value>>, NeuronCount<Q::NeuronIndex>), FeagiNPUSynapseError>
    {
        self.get_synapse_data_from_source_neuron_index(&source_neuron_index)
    }

    fn get_nonplastic_synapse_data_from_source_neuron_index_mut(&mut self, source_neuron_index: NPUNeuronIndex<Q::NeuronIndex>) -> Result<(impl Iterator<Item=&mut NonPlasticSynapseFull<Q::NeuronIndex, Q::BurstDelta, Q::Value>>, NeuronCount<Q::NeuronIndex>), FeagiNPUSynapseError> {
        self.get_synapse_data_from_source_neuron_index_mut(&source_neuron_index)
    }

    fn get_nonplastic_synapse_data_from_destination_neuron_index(&self, destination_neuron_index: NPUNeuronIndex<Q::NeuronIndex>) -> Result<(impl Iterator<Item=&NonPlasticSynapseFull<Q::NeuronIndex, Q::BurstDelta, Q::Value>>, NeuronCount<Q::NeuronIndex>), FeagiNPUSynapseError> {
        self.get_synapse_data_from_destination_neuron_index(&destination_neuron_index)
    }

    fn get_nonplastic_synapse_data_from_destination_neuron_index_mut(&mut self, destination_neuron_index: NPUNeuronIndex<Q::NeuronIndex>) -> Result<(impl Iterator<Item=&mut NonPlasticSynapseFull<Q::NeuronIndex, Q::BurstDelta, Q::Value>>, NeuronCount<Q::NeuronIndex>), FeagiNPUSynapseError> {
...
NonplasticDimensionalSynapseAllocRAMStorage<Q>
{
    fn remove_all_synapses_mappings_to_and_from_cortical_area(&mut self, area_index: CorticalAreaIndex<Q::CorticalIndex>) {
        todo!()
    }

    fn remove_all_synaptic_mappings_between_cortical_areas(&mut self, source_area_index: CorticalAreaIndex<Q::CorticalIndex>, destination_area_index: CorticalAreaIndex<Q::CorticalIndex>) {
        todo!()
    }
}
...
NonplasticDimensionalSynapseAllocRAMStorage<Q>
{
    ...
    fn get_destination_neuron_indexes_from_source_neuron_index(&self, source_neuron_index: NPUNeuronIndex<Q::NeuronIndex>) -> Result<&[NPUNeuronIndex<Q::NeuronIndex>], FeagiNPUSynapseError> {
        todo!()
    }

    fn get_source_neuron_indexes_from_destination_neuron_index(&self, destination_neuron_index: NPUNeuronIndex<Q::NeuronIndex>) -> Result<&[NPUNeuronIndex<Q::NeuronIndex>], FeagiNPUSynapseError> {
        todo!()
    }
    ...
    fn invalidate_synapse_by_synapse_index(&mut self, synapse_index: NPUSynapseIndex<Q::SynapseIndex>) -> Result<(), FeagiNPUSynapseError> {
        todo!()
    }

    fn invalidate_synapses_by_synapse_indexes(&mut self, synapse_index: NPUSynapseIndex<Q::SynapseIndex>) -> Result<(), FeagiNPUSynapseError> {
        todo!()
    }

    fn invalidate_synapses_with_source_neuron_index(&mut self, source_neurons_index: NPUNeuronIndex<Q::NeuronIndex>) -> Result<SynapseCount<Q::SynapseIndex>, FeagiNPUSynapseError> {
        todo!()
    }

    fn invalidate_synapses_with_source_neuron_indexes(&mut self, source_neurons_indexes: &[NPUNeuronIndex<Q::NeuronIndex>]) -> Result<SynapseCount<Q::SynapseIndex>, FeagiNPUSynapseError> {
        todo!()
    }

    fn invalidate_synapses_with_destination_neuron_index(&mut self, destination_neurons_index: NPUNeuronIndex<Q::NeuronIndex>) -> Result<SynapseCount<Q::SynapseIndex>, FeagiNPUSynapseError> {
        todo!()
    }

    fn invalidate_synapses_with_destination_neuron_indexes(&mut self, destination_neurons_indexes: &[NPUNeuronIndex<Q::NeuronIndex>]) -> Result<SynapseCount<Q::SynapseIndex>, FeagiNPUSynapseError> {
        todo!()
    }
    //endregion
}
