...
pub use templates::{
    ...
    create_genome_with_core_morphologies, create_minimal_genome, create_pain_area,
    create_pleasure_area, create_power_area, ensure_core_components, get_default_neural_properties,
