...
mod test_brain_region {
    ...
    fn test_add_remove_areas() {
        let region_id = RegionID::new();
        let mut region =
            BrainRegion::new(region_id, "Test".to_string(), RegionType::Undefined).unwrap();
    ...
    fn test_with_areas() {
        ...
        let region_id = RegionID::new();
        let region = BrainRegion::new(region_id, "Test".to_string(), RegionType::Undefined)
            .unwrap()
    ...
    fn test_properties() {
        ...
        region.add_property(
            ...
            serde_json::json!("Visual processing region"),
        );
        ...
        assert_eq!(
            ...
            Some(&serde_json::json!("Visual processing region"))
        );
    ...
    fn test_clear_areas() {
        ...
        let region_id = RegionID::new();
        let mut region = BrainRegion::new(region_id, "Test".to_string(), RegionType::Undefined)
            .unwrap()
    ...
    fn test_serialization() {
        ...
        let region_id = RegionID::new();
        let region = BrainRegion::new(region_id, "Test Region".to_string(), RegionType::Undefined)
            .unwrap()
    ...
    fn test_genome_format_serialization() {
        ...
        region.add_property(
            "description".to_string(),
            serde_json::json!("Default root region for brain organization"),
        );
