...
use crate::neuron::neuron_base_enums::NeuronCollectionType;
use crate::quantization_level::CorticalAreaNeuronQuantization;

/// Defines the properties of a single neuron of a given Neuron Model
pub trait NeuronModelValuesBaseTrait<CANQ: CorticalAreaNeuronQuantization> {
    ...
    define_ref_access_trait_methods!(neuron_flag, Self::NeuronFlagType);
}


/// Base trait defining all possible neuron data collections
pub trait NeuronDataContainerBaseTrait<CANQ: CorticalAreaNeuronQuantization, NMV> 
where
    NMV: NeuronModelValuesBaseTrait<CANQ>
{
