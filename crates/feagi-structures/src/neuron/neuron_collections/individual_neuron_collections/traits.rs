use crate::neuron::neuron_collections::base_neuron_collection_traits::NeuronCollectionBase;
use crate::neuron::neuron_collections::common_neuron_structs::{IndividualNeuronIndexCount, IndividualNeuronMembranePotential, NeuronVoxelCoordinate};
