use crate::base_feagi_types::quantizable_types::{FeagiBaseQuantizationType, QuantizableUIntType};
...
macro_rules! define_nonzero_count_family {
    ($base_name:ident) => {
        ...
        pub struct $base_name<T: $crate::base_feagi_types::quantizable_types::QuantizableNonzeroUIntType>(pub T);
        ...
        impl<T: $crate::base_feagi_types::quantizable_types::QuantizableNonzeroUIntType> From<$base_name<T>> for usize {
            #[inline(always)]
        ...
        #[cfg(feature = "alloc")]
        impl<T: $crate::base_feagi_types::quantizable_types::QuantizableNonzeroUIntType + core::fmt::Display> core::fmt::Display
            for $base_name<T>
        {
            #[inline(always)]
        ...
        impl<T: $crate::base_feagi_types::quantizable_types::QuantizableNonzeroUIntType> $crate::base_feagi_types::quantizable_types::QuantizableNonzeroUIntType
            for $base_name<T>
        {
