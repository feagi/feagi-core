            ...
            $(
                paste::paste! {
                    ...
                    pub const fn [<get_cortical_ids_array_for_ $variant_name:snake _with_parameters >](
                        ...
                        [
                            $(
                                $io_cortical_area_configuration_flag_expr .as_io_cortical_id(false, cortical_unit_identifier, cortical_unit_index, CorticalSubUnitIndex::const_from($cortical_sub_unit_index))
                            ),*
                        ]
                    }
                }
