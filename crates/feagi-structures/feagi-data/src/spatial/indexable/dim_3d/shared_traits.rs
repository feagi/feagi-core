...
pub trait SpatialIndexingCoordinate3D<LinearIndexCount>:
...
pub trait SpatialIndexingDimension3D<LinearIndexCount, CoordinateType>:
SpatialIndexingDimension<LinearIndexCount, CoordinateType>
where
    LinearIndexCount: LinearIndexCountType,
    CoordinateType: SpatialIndexingCoordinate3D<LinearIndexCount>,
{
    ...
    fn get_max_linear_index(&self) -> LinearIndexCount {
        self.get_x_dim() * self.get_y_dim() * self.get_z_dim()
    }
