...
macro_rules! define_unsigned_spatial_4d_cpu_wrappers {
    (
        ...
        where
            ...
            $t_axis_wrapper_type: $crate::quantizable_types::index_count::QuantizedIndexCountWrapperTrait<QuantIndex>,
        {
            ...
            $t_axis_wrapper_type: $crate::quantizable_types::index_count::QuantizedIndexCountWrapperTrait<QuantIndex>,
        {
            ...
            pub fn new_checked(
                ...
                $crate::quantizable_spatial::unsigned_spatial_4d::spatial_unsigned_4d::verify_linear_index_within_unsigned_4d_bounds(
                    ...
                    *<$t_axis_wrapper_type as $crate::quantizable_types::index_count::QuantizedIndexCountWrapperTrait<QuantIndex>>::quant_ref(&t),
                )?;
                Ok(Self {
                    x,
                    y,
            ...
            $t_axis_wrapper_type: $crate::quantizable_types::index_count::QuantizedIndexCountWrapperTrait<QuantIndex>,
        {
            ...
            fn new_unchecked(x: QuantIndex, y: QuantIndex, z: QuantIndex, t: QuantIndex) -> Self {
                Self {
                    ...
                    t: <$t_axis_wrapper_type as $crate::quantizable_types::index_count::QuantizedIndexCountWrapperTrait<QuantIndex>>::wrap_quant(t),
                    _p: core::marker::PhantomData,
                }
            }
        }
            ...
            $t_axis_wrapper_type: $crate::quantizable_types::index_count::QuantizedIndexCountWrapperTrait<QuantIndex>,
        {
            fn fmt(&self, formatter: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                formatter
                    ...
                    .field("t", <$t_axis_wrapper_type as $crate::quantizable_types::index_count::QuantizedIndexCountWrapperTrait<QuantIndex>>::quant_ref(&self.t))
                    .finish()
            }
        }
            ...
            $t_axis_wrapper_type: $crate::quantizable_types::index_count::QuantizedIndexCountWrapperTrait<QuantIndex>,
        {
            fn fmt(&self, formatter: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                write!(
                    ...
                    <$t_axis_wrapper_type as $crate::quantizable_types::index_count::QuantizedIndexCountWrapperTrait<QuantIndex>>::quant_ref(&self.t)
                )
            }
        }
