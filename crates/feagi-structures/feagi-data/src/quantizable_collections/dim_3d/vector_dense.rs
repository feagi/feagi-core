...
impl<LIQ, Value> QuantizableLinearCollectionCPUIterWithIndex<LIQ, Value> for QuantizableSpatialCollection3DVectorDense<LIQ, Value>
where
    LIQ: QuantizedIndexCountTrait,
    Value: Clone
{
...
impl<LIQ, Value> PDITagGenericDevice for QuantizableSpatialCollection3DVectorDense<LIQ, Value> where LIQ: QuantizedIndexCountTrait, Value: Clone, {}

impl<LIQ, Value> PDITagCPU for QuantizableSpatialCollection3DVectorDense<LIQ, Value> where LIQ: QuantizedIndexCountTrait, Value: Clone, {}
