...
pub trait FeagiECSElementSetGenericDevice<ChildElement>: FeagiECSElementGenericDevice // Already extends FeagiECSTagGenericDevice
where
    ChildElement: FeagiECSElementGenericDevice
{}
