...
impl ApiState {
    ...
    pub fn init_agent_registration_handler(
        ...
        {
            let sensory_address =
                format_tcp_endpoint(&config.zmq.bind_host, config.ports.zmq_sensory_port);
            let sensory_adv_address =
                format_tcp_endpoint(&config.zmq.advertised_host, config.ports.zmq_sensory_port);
            let motor_address =
                format_tcp_endpoint(&config.zmq.bind_host, config.ports.zmq_motor_port);
            let motor_adv_address =
                format_tcp_endpoint(&config.zmq.advertised_host, config.ports.zmq_motor_port);
            let visualization_address =
                format_tcp_endpoint(&config.zmq.bind_host, config.ports.zmq_visualization_port);
            let visualization_adv_address = format_tcp_endpoint(
        ...
        {
            let sensory_address =
                format_ws_address(&config.websocket.bind_host, config.websocket.sensory_port);
            let sensory_adv_address = format_ws_address(
            ...
            let sensory = FeagiWebSocketServerPullerProperties::new_with_remote(
                &sensory_address,
                &sensory_adv_address,
            )
...
fn create_v1_router() -> Router<ApiState> {
    ...
    Router::new()
        ...
        .route(
            ...
            get(system::get_user_preferences).put(system::put_user_preferences),
        )
        .route(
            "/system/cortical_area_types",
            get(system::get_cortical_area_types_list),
        )
        .route(
            "/system/enable_visualization_fq_sampler",
            axum::routing::post(system::post_enable_visualization_fq_sampler),
        )
        .route(
            "/system/disable_visualization_fq_sampler",
            axum::routing::post(system::post_disable_visualization_fq_sampler),
        )
        .route("/system/fcl_status", get(system::get_fcl_status_system))
        .route(
            "/system/fcl_reset",
            axum::routing::post(system::post_fcl_reset_system),
        )
        ...
        .route(
            ...
            get(system::get_beacon_subscribers),
        )
        .route(
            "/system/beacon/subscribe",
            axum::routing::post(system::post_beacon_subscribe),
        )
        .route(
            "/system/beacon/unsubscribe",
            axum::routing::delete(system::delete_beacon_unsubscribe),
        )
        .route(
            "/system/global_activity_visualization",
            get(system::get_global_activity_visualization)
                .put(system::put_global_activity_visualization),
        )
        .route(
            "/system/circuit_library_path",
            axum::routing::post(system::post_circuit_library_path),
        )
        .route("/system/db/influxdb/test", get(system::get_influxdb_test))
        .route(
            "/system/register",
            axum::routing::post(system::post_register_system),
        )
        // ===== CORTICAL_AREA MODULE (25 endpoints) =====
        .route("/cortical_area/ipu", get(cortical_area::get_ipu))
        .route(
            "/cortical_area/ipu/types",
            get(cortical_area::get_ipu_types),
        )
        .route("/cortical_area/opu", get(cortical_area::get_opu))
        .route(
            "/cortical_area/opu/types",
            get(cortical_area::get_opu_types),
        )
        .route(
            "/cortical_area/cortical_area_id_list",
            get(cortical_area::get_cortical_area_id_list),
        )
        .route(
            "/cortical_area/cortical_area_name_list",
            get(cortical_area::get_cortical_area_name_list),
        )
        .route(
            "/cortical_area/cortical_id_name_mapping",
            get(cortical_area::get_cortical_id_name_mapping),
        )
        .route(
            "/cortical_area/cortical_types",
            get(cortical_area::get_cortical_types),
        )
        .route(
            "/cortical_area/cortical_map_detailed",
            get(cortical_area::get_cortical_map_detailed),
        )
        .route(
            "/cortical_area/cortical_locations_2d",
            get(cortical_area::get_cortical_locations_2d),
        )
        .route(
            "/cortical_area/cortical_area/geometry",
            get(cortical_area::get_cortical_area_geometry),
        )
        .route(
            "/cortical_area/cortical_visibility",
            get(cortical_area::get_cortical_visibility),
        )
        .route(
            "/cortical_area/cortical_name_location",
            axum::routing::post(cortical_area::post_cortical_name_location),
        )
        .route(
            "/cortical_area/cortical_area_properties",
            axum::routing::post(cortical_area::post_cortical_area_properties),
        )
        .route(
            "/cortical_area/multi/cortical_area_properties",
            axum::routing::post(cortical_area::post_multi_cortical_area_properties),
        )
        .route(
        ...
        .route(
            ...
            put(cortical_area::put_multi_cortical_area)
                .delete(cortical_area::delete_multi_cortical_area),
        )
        .route("/cortical_area/coord_2d", put(cortical_area::put_coord_2d))
        .route(
            "/cortical_area/suppress_cortical_visibility",
            put(cortical_area::put_suppress_cortical_visibility),
        )
        .route("/cortical_area/reset", put(cortical_area::put_reset))
        .route(
            "/cortical_area/visualization",
            get(cortical_area::get_visualization),
        )
        .route(
            "/cortical_area/batch_operations",
            axum::routing::post(cortical_area::post_batch_operations),
        )
        .route("/cortical_area/ipu/list", get(cortical_area::get_ipu_list))
        .route("/cortical_area/opu/list", get(cortical_area::get_opu_list))
        .route(
            "/cortical_area/coordinates_3d",
            put(cortical_area::put_coordinates_3d),
        )
        .route(
            "/cortical_area/bulk_delete",
            axum::routing::delete(cortical_area::delete_bulk),
        )
        .route(
            "/cortical_area/resize",
            axum::routing::post(cortical_area::post_resize),
        )
        .route(
            "/cortical_area/reposition",
            axum::routing::post(cortical_area::post_reposition),
        )
        .route(
        ...
        .route(
            "/cortical_area/cortical_idx_mapping",
            get(cortical_area::get_cortical_idx_mapping),
        )
        .route(
            "/cortical_area/mapping_restrictions",
            get(cortical_area::get_mapping_restrictions_query)
                .post(cortical_area::post_mapping_restrictions),
        )
        .route(
            "/cortical_area/:cortical_id/memory_usage",
            get(cortical_area::get_memory_usage),
        )
        .route(
            "/cortical_area/:cortical_id/neuron_count",
            get(cortical_area::get_area_neuron_count),
        )
        .route(
            "/cortical_area/cortical_type_options",
            axum::routing::post(cortical_area::post_cortical_type_options),
        )
        .route(
            "/cortical_area/mapping_restrictions_between_areas",
        ...
        .route(
            "/morphology/morphology_usage",
            axum::routing::post(morphology::post_morphology_usage),
        )
        .route("/morphology/list", get(morphology::get_list))
        .route("/morphology/info/:morphology_id", get(morphology::get_info))
        .route(
            "/morphology/create",
            axum::routing::post(morphology::post_create),
        )
        .route(
            "/morphology/update",
            axum::routing::put(morphology::put_update),
        )
        .route(
            "/morphology/delete/:morphology_id",
            axum::routing::delete(morphology::delete_morphology),
        )
        ...
        .route(
            "/region/relocate_members",
            put(region::put_relocate_members),
        )
        .route(
            "/region/region_and_members",
            axum::routing::delete(region::delete_region_and_members),
        )
        ...
        .route(
            "/region/change_region_parent",
            put(region::put_change_region_parent),
        )
        .route(
            "/region/change_cortical_area_region",
            put(region::put_change_cortical_area_region),
        )
        // ===== CORTICAL_MAPPING MODULE (8 endpoints) =====
        .route(
            "/cortical_mapping/afferents",
            axum::routing::post(cortical_mapping::post_afferents),
        )
        .route(
            "/cortical_mapping/efferents",
            axum::routing::post(cortical_mapping::post_efferents),
        )
        .route(
            "/cortical_mapping/mapping_properties",
            axum::routing::post(cortical_mapping::post_mapping_properties)
                .put(cortical_mapping::put_mapping_properties),
        )
        .route(
            "/cortical_mapping/mapping",
            get(cortical_mapping::get_mapping).delete(cortical_mapping::delete_mapping),
        )
        .route(
            "/cortical_mapping/mapping_list",
        ...
        .route(
            "/cortical_mapping/mapping",
            axum::routing::post(cortical_mapping::post_mapping).put(cortical_mapping::put_mapping),
        )
        // ===== CONNECTOME MODULE (21 endpoints) =====
        .route(
            "/connectome/cortical_areas/list/detailed",
            get(connectome::get_cortical_areas_list_detailed),
        )
        .route(
            "/connectome/properties/dimensions",
            get(connectome::get_properties_dimensions),
        )
        .route(
            "/connectome/properties/mappings",
            get(connectome::get_properties_mappings),
        )
        .route("/connectome/snapshot", get(connectome::get_snapshot))
        .route("/connectome/stats", get(connectome::get_stats))
        .route(
            "/connectome/batch_neuron_operations",
            axum::routing::post(connectome::post_batch_neuron_operations),
        )
        .route(
            "/connectome/batch_synapse_operations",
            axum::routing::post(connectome::post_batch_synapse_operations),
        )
        .route(
            "/connectome/neuron_count",
            get(connectome::get_neuron_count),
        )
        .route(
            "/connectome/synapse_count",
            get(connectome::get_synapse_count),
        )
        .route("/connectome/paths", get(connectome::get_paths))
        .route(
            "/connectome/cumulative_stats",
            get(connectome::get_cumulative_stats),
        )
        .route(
            "/connectome/area_details",
            get(connectome::get_area_details),
        )
        .route(
            "/connectome/rebuild",
            axum::routing::post(connectome::post_rebuild),
        )
        .route("/connectome/structure", get(connectome::get_structure))
        .route(
            "/connectome/clear",
            axum::routing::post(connectome::post_clear),
        )
        .route("/connectome/validation", get(connectome::get_validation))
        .route("/connectome/topology", get(connectome::get_topology))
        .route(
            "/connectome/optimize",
            axum::routing::post(connectome::post_optimize),
        )
        .route(
            "/connectome/connectivity_matrix",
            get(connectome::get_connectivity_matrix),
        )
        .route(
            "/connectome/neurons/batch",
            axum::routing::post(connectome::post_neurons_batch),
        )
        .route(
            "/connectome/synapses/batch",
            axum::routing::post(connectome::post_synapses_batch),
        )
        .route(
            "/connectome/cortical_areas/list/summary",
            get(connectome::get_cortical_areas_list_summary),
        )
        .route(
            "/connectome/cortical_areas/list/transforming",
            get(connectome::get_cortical_areas_list_transforming),
        )
        .route(
            "/connectome/cortical_area/list/types",
            get(connectome::get_cortical_area_list_types),
        )
        .route(
            "/connectome/cortical_area/:cortical_id/neurons",
        ...
        .route(
            "/connectome/cortical_info/:cortical_area",
        ...
        .route(
            "/connectome/neuron/:neuron_id/properties",
            get(connectome::get_neuron_properties_by_id),
        )
        .route(
            "/connectome/neuron_properties",
        ...
        .route(
            "/connectome/fire_queue/:cortical_area",
            get(connectome::get_fire_queue_area),
        )
        .route(
            "/connectome/plasticity",
            get(connectome::get_plasticity_info),
        )
        ...
        .route(
            "/burst_engine/simulation_timestep",
        ...
        .route(
            ...
            axum::routing::post(burst_engine::post_fcl_reset),
        )
        .route(
            "/burst_engine/fcl_status",
            get(burst_engine::get_fcl_status),
        )
        .route(
            "/burst_engine/fcl_sampler/config",
            get(burst_engine::get_fcl_sampler_config).post(burst_engine::post_fcl_sampler_config),
        )
        .route(
            "/burst_engine/fcl_sampler/area/:area_id/sample_rate",
            get(burst_engine::get_area_fcl_sample_rate)
                .post(burst_engine::post_area_fcl_sample_rate),
        )
        .route(
            "/burst_engine/fire_ledger/default_window_size",
            get(burst_engine::get_fire_ledger_default_window_size)
                .put(burst_engine::put_fire_ledger_default_window_size),
        )
        .route(
            "/burst_engine/fire_ledger/areas_window_config",
        ...
        .route(
            "/burst_engine/control",
            axum::routing::post(burst_engine::post_control),
        )
        .route(
            "/burst_engine/burst_counter",
            get(burst_engine::get_burst_counter),
        )
        .route(
            "/burst_engine/start",
            axum::routing::post(burst_engine::post_start),
        )
        .route(
            "/burst_engine/stop",
            axum::routing::post(burst_engine::post_stop),
        )
        .route(
            "/burst_engine/hold",
            axum::routing::post(burst_engine::post_hold),
        )
        .route(
            "/burst_engine/resume",
            axum::routing::post(burst_engine::post_resume),
        )
        .route(
            "/burst_engine/config",
            get(burst_engine::get_config).put(burst_engine::put_config),
        )
        .route(
            "/burst_engine/fire_ledger/area/:area_id/window_size",
            get(burst_engine::get_fire_ledger_area_window_size)
                .put(burst_engine::put_fire_ledger_area_window_size),
        )
        .route(
            "/burst_engine/fire_ledger/area/:area_id/history",
            get(burst_engine::get_fire_ledger_history),
        )
        .route(
            "/burst_engine/membrane_potentials",
            get(burst_engine::get_membrane_potentials).put(burst_engine::put_membrane_potentials),
        )
        .route(
            "/burst_engine/frequency_status",
            get(burst_engine::get_frequency_status),
        )
        .route(
            "/burst_engine/measure_frequency",
            axum::routing::post(burst_engine::post_measure_frequency),
        )
        .route(
            "/burst_engine/frequency_history",
            get(burst_engine::get_frequency_history),
        )
        .route(
            "/burst_engine/force_connectome_integration",
            axum::routing::post(burst_engine::post_force_connectome_integration),
        )
        // ===== GENOME MODULE (22 endpoints) =====
        .route("/genome/file_name", get(genome::get_file_name))
        .route("/genome/circuits", get(genome::get_circuits))
        .route(
            "/genome/amalgamation_destination",
            axum::routing::post(genome::post_amalgamation_destination),
        )
        .route(
            "/genome/amalgamation_cancellation",
            axum::routing::delete(genome::delete_amalgamation_cancellation),
        )
        .route(
            "/feagi/genome/append",
            axum::routing::post(genome::post_genome_append),
        )
        .route(
            "/genome/upload/barebones",
            axum::routing::post(genome::post_upload_barebones_genome),
        )
        .route(
            "/genome/upload/essential",
            axum::routing::post(genome::post_upload_essential_genome),
        )
        ...
        .route(
            "/genome/validate",
            axum::routing::post(genome::post_validate),
        )
        .route(
            "/genome/transform",
            axum::routing::post(genome::post_transform),
        )
        ...
        .route(
            ...
            get(genome::get_cortical_template),
        )
        ...
        .route(
            ...
            axum::routing::post(genome::post_amalgamation_by_filename),
        )
        .route(
        ...
        .route(
            ...
            axum::routing::post(genome::post_upload_string),
        )
        // ===== NEUROPLASTICITY MODULE (7 endpoints) =====
        .route(
            "/neuroplasticity/plasticity_queue_depth",
            get(neuroplasticity::get_plasticity_queue_depth)
                .put(neuroplasticity::put_plasticity_queue_depth),
        )
        .route("/neuroplasticity/status", get(neuroplasticity::get_status))
        .route(
            "/neuroplasticity/transforming",
            get(neuroplasticity::get_transforming),
        )
        .route(
            "/neuroplasticity/configure",
            axum::routing::post(neuroplasticity::post_configure),
        )
        .route(
            "/neuroplasticity/enable/:area_id",
            axum::routing::post(neuroplasticity::post_enable_area),
        )
        .route(
            "/neuroplasticity/disable/:area_id",
            axum::routing::post(neuroplasticity::post_disable_area),
        )
        // ===== INSIGHT MODULE (6 endpoints) =====
        .route(
            "/insight/neurons/membrane_potential_status",
            axum::routing::post(insight::post_neurons_membrane_potential_status),
        )
        .route(
            "/insight/neuron/synaptic_potential_status",
            axum::routing::post(insight::post_neuron_synaptic_potential_status),
        )
        .route(
            "/insight/neurons/membrane_potential_set",
            axum::routing::post(insight::post_neurons_membrane_potential_set),
        )
        .route(
            "/insight/neuron/synaptic_potential_set",
            axum::routing::post(insight::post_neuron_synaptic_potential_set),
        )
        ...
        .route(
            "/simulation/upload/string",
            axum::routing::post(simulation::post_stimulation_upload),
        )
        .route(
            "/simulation/reset",
            axum::routing::post(simulation::post_reset),
        )
        .route("/simulation/status", get(simulation::get_status))
        .route("/simulation/stats", get(simulation::get_stats))
        .route(
            "/simulation/config",
            axum::routing::post(simulation::post_config),
        )
        ...
        .route(
            "/training/shock/activate",
            axum::routing::post(training::post_shock_activate),
        )
        .route(
            "/training/reward/intensity",
            axum::routing::post(training::post_reward_intensity),
        )
        .route(
            "/training/reward",
            axum::routing::post(training::post_reward),
        )
        .route(
            "/training/punishment/intensity",
            axum::routing::post(training::post_punishment_intensity),
        )
        .route(
            "/training/punishment",
            axum::routing::post(training::post_punishment),
        )
        .route(
            "/training/gameover",
            axum::routing::post(training::post_gameover),
        )
        .route("/training/brain_fitness", get(training::get_brain_fitness))
        .route(
            "/training/fitness_criteria",
            get(training::get_fitness_criteria)
                .put(training::put_fitness_criteria)
                .post(training::post_fitness_criteria),
        )
        .route(
            "/training/fitness_stats",
            get(training::get_fitness_stats)
                .put(training::put_fitness_stats)
                .delete(training::delete_fitness_stats),
        )
        .route(
            "/training/reset_fitness_stats",
            axum::routing::delete(training::delete_reset_fitness_stats),
        )
        .route(
            "/training/training_report",
            get(training::get_training_report),
        )
        .route("/training/status", get(training::get_status))
        .route("/training/stats", get(training::get_stats))
        .route(
            "/training/config",
            axum::routing::post(training::post_config),
        )
        // ===== VISUALIZATION MODULE (4 endpoints) =====
        .route(
            "/visualization/register_client",
            axum::routing::post(visualization::post_register_client),
        )
        .route(
            "/visualization/unregister_client",
            axum::routing::post(visualization::post_unregister_client),
        )
        .route(
            "/visualization/heartbeat",
        ...
        .route(
            "/evolution/config",
            axum::routing::post(evolution::post_config),
        )
...
async fn placeholder_handler(State(_state): State<ApiState>) -> Response {
    (
...
async fn placeholder_health_check(State(_state): State<ApiState>) -> Response {
    (
        StatusCode::OK,
        Json(serde_json::json!({
            "status": "ok",
