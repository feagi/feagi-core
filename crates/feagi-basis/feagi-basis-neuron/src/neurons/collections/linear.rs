use feagi_data_quantization::generic_collections::bitpacked::linear::{BitPackedArraySizeAware, BitPackedSliceMutSizeAware, BitPackedSliceSizeAware, BitPackedVectorSizeAware};
use feagi_data_quantization::generic_collections::generic_par_data::linear::{ParDataArray, ParDataSlice, ParDataSliceMut, ParDataVector};
