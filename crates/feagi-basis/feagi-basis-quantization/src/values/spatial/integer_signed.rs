        ...
        D: serde::Deserializer<'de>,
    {
            ...
            for SignedIntegerSpatialVisitor<Q, NUM_DIMS>
        {
                ...
                A: SeqAccess<'de>,
            {
                ...
                Ok(SignedIntegerSpatial { data })
            }
        }

        deserializer.deserialize_seq(SignedIntegerSpatialVisitor::<Q, NUM_DIMS>(PhantomData))
    }
}
    ...
    Copy + Clone + Send + Sync + core::fmt::Debug + core::cmp::PartialEq + core::cmp::Eq + core::hash::Hash + Sized + 'static
{
    ...
    fn new_from_quant_unchecked<FromQuant: QuantizedSignedIntegerTrait>(value: SignedIntegerSpatial<FromQuant, NUM_DIMS>) -> Self;
...
pub trait SignedIntegerSpatialUnwrappedTrait<Q: QuantizedSignedIntegerTrait, const NUM_DIMS: usize>: SignedIntegerSpatialTrait<Q, NUM_DIMS> {}
...
pub trait SignedIntegerSpatialWrappedTrait<Q: QuantizedSignedIntegerTrait, const NUM_DIMS: usize>:
    SignedIntegerSpatialTrait<Q, NUM_DIMS> + From<SignedIntegerSpatial<Q, NUM_DIMS>> + AsRef<SignedIntegerSpatial<Q, NUM_DIMS>>
{
...
impl<Q: QuantizedSignedIntegerTrait, const NUM_DIMS: usize> SignedIntegerSpatialTrait<Q, NUM_DIMS> for SignedIntegerSpatial<Q, NUM_DIMS> {
...
impl<Q: QuantizedSignedIntegerTrait, const NUM_DIMS: usize> SignedIntegerSpatialUnwrappedTrait<Q, NUM_DIMS> for SignedIntegerSpatial<Q, NUM_DIMS> {}
