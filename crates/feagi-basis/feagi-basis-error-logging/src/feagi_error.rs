...
/// not supported! Best implemented with by deriving "FeagiFail"
///
/// ```ignore
/// #[derive(FeagiFail)]
...
/// }
/// ```
pub trait FeagiFailTrait: core::fmt::Debug + core::fmt::Display + Sized + 'static {
    fn context(&self) -> &'static str;
}

/// A no-alloc FEAGI error enum.
///
/// Derived enums are expected to wrap either a `FeagiFailTrait` key or
