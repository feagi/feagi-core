        ...
        // Register a simple sensor
        {
            ...
            sensor_cache
                .infrared_register(
                    ...
                    feagi_genomic_context::cortical_area::descriptors::NeuronDepth::new(10)
                        .unwrap(),
...

        {
            ...
            motor_cache
                .simple_vision_output_register(
                    feagi_genomic_context::cortical_area::descriptors::CorticalUnitIndex::from(0u8),
                    feagi_genomic_context::cortical_area::descriptors::CorticalChannelCount::new(1).unwrap(),
        ...
        // Register a sensor
        {
            ...
            sensor_cache
                .infrared_register(
                    ...
                    FrameChangeHandling::Absolute,
                    feagi_genomic_context::cortical_area::descriptors::NeuronDepth::new(8)
                        .unwrap(),
