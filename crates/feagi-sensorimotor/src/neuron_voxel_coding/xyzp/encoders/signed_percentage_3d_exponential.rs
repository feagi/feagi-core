...
type ScratchSpaceTuple3DSigned = (
    (Vec<u32>, Vec<u32>),
    (Vec<u32>, Vec<u32>),
    (Vec<u32>, Vec<u32>),
);
...
pub struct SignedPercentage3DExponentialNeuronVoxelXYZPEncoder {
    ...
    scratch_space: Vec<ScratchSpaceTuple3DSigned>, // # channels long - (a_pos, a_neg), (b_pos, b_neg), (c_pos, c_neg)
}
