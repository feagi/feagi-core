...
fn bench_cpu_backend(c: &mut Criterion) {
    use feagi_burst_engine::backend::{CPUBackend, ComputeBackend};
...
fn bench_gpu_backend(c: &mut Criterion) {
    use feagi_burst_engine::backend::{WGPUBackend, ComputeBackend};
...
fn bench_cpu_vs_gpu_comparison(c: &mut Criterion) {
    use feagi_burst_engine::backend::{CPUBackend, WGPUBackend, ComputeBackend};
...
fn bench_auto_selection(c: &mut Criterion) {
    use feagi_burst_engine::backend::{select_backend, BackendConfig};
