        ...
        + ComputeBackend<INT8Value, R::NeuronStorage<INT8Value>, R::SynapseStorage>,
{
    ...
    pub fn get_last_fcl_snapshot(&self) -> Vec<(feagi_neural::types::NeuronId, f32)> {
    ...
    pub fn batch_get_neuron_ids_from_coordinates(&self, area_id: u32, coords: &[(u32, u32, u32)]) -> Vec<feagi_neural::types::NeuronId> {
