...
use crate::cortical_area::cortical_writer::NeuronModelCorticalWriter;
use crate::cortical_area::{CorticalAreaProperties, PostCorticalPotential};
...
use crate::cortical_area::implementations::feagi_advanced::data::{ConsecutiveFireCountdown, ConsecutiveFireLimit, DegeneracyConstant, FeagiAdvancedModelCorticalData, FeagiAdvancedModelNeuronData, LeakCoefficient, RefractoryCountdown, RefractoryPeriodLimit, SnoozePeriod};
