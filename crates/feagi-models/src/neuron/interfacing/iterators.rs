...
/// Common trait that defines how to iterate the neurons over a no layout cortical area
pub trait NoneLayoutCorticalNeuronIterator<FIQ: FeagiIndexQuantization> {
