...
use crate::neuron::cortical_area_layout::{CorticalAreaLayout, CorticalAreaLayoutDimensional, CorticalAreaLayoutFormless};
...
impl<FIQ: FeagiIndexQuantization> CorticalAreaLayoutNested<FIQ> {
    ...
    pub fn get_total_number_neurons(&self) -> NeuronCorticalLocalIndex<FIQ::NeuronIndexQuant> {
        match self {
