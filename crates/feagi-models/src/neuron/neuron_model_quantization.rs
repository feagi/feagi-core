...
pub trait NeuronModelQuantization: MembranePotentialQuantization + Default + Clone {
    ...
    const PACKED_NEURON_MODEL_AND_QUANTIZATION: NeuronModelTypeAndQuantizationPacked = NeuronModelTypeAndQuantizationPacked::from_nested(Self::NESTED_NEURON_MODEL_AND_QUANTIZATION);
