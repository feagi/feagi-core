...
use feagi_data::feagi_data_quantization::values::quantizable::PercentageUnsigned;
...
create_wrapped_quantized_unsigned_integer_index!(pub RefractoryPeriodLimit);
// Fire threshold is just membrane potential
create_wrapped_quantized_unsigned_integer_index!(pub ConsecutiveFireLimit);
create_wrapped_quantized_unsigned_integer_index!(pub SnoozePeriod);
create_wrapped_quantized_decimal!(pub DegeneracyConstant);

create_wrapped_quantized_decimal!(pub LeakCoefficient);
create_wrapped_quantized_unsigned_integer_index!(pub RefractoryCountdown);
create_wrapped_quantized_unsigned_integer_index!(pub ConsecutiveFireCountdown);
