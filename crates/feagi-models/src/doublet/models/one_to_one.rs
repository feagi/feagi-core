...
impl<FIQ: FeagiIndexQuantization> DoubletIteratorOneToOne<FIQ> {
    pub fn new(
        ...
        let source_probe = DimensionCorticalArea4DCoordinate::new_from_voxel_and_density(
            source_voxel_coordinate,
            NeuronVoxelDensityIndex::QUANT_ZERO,
        );
        let destination_probe = DimensionCorticalArea4DCoordinate::new_from_voxel_and_density(
